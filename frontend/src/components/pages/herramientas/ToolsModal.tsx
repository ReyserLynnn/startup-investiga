      ...
      <DialogTrigger asChild>
        ...
        >
          ...
          <img
            src={logo}
            alt={name}
            className="absolute top-0 left-0 blur-xl -z-10 opacity-0 w-full h-auto group-hover:opacity-100 transition-all rounded-lg"
          />
        </button>
      </DialogTrigger>
        ...
        <DialogHeader>
          <div className="w-full flex justify-between items-center relative">
            <div className="flex flex-col gap-2 items-center w-full">
              ...
              />
              <a
                className="text-4xl font-bold w-full text-center hover:underline"
                href={homepage}
              >
                {name}
              </a>
            ...
            <Button
              className="flex gap-2 absolute top-0 right-0"
              variant="ghost"
            >
              {numberLikes}
              <HeartIcon />
