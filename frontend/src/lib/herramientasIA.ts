  ...
  return [
    {
      title: 'ChatGPT',
      description:
        'Asistente de IA que ayuda a generar y revisar textos científicos y resolver dudas.',
      image: '/logosIA/chatgpt.webp',
    },
    {
      title: 'Perplexity',
      description:
        'Herramienta para evaluar la precisión y calidad de modelos de lenguaje en textos científicos.',
